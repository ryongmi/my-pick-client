  ...
  return (
    <>
      <div className={cn("flex items-center gap-4", className)}>
        ...
        {/* 일괄 작업 드롭다운 */}
        {hasSelection ? <div className="relative">
            <Button
              variant="outline"
              size="sm"
            ...
            {dropdownOpen ? <div className="absolute top-full left-0 mt-1 w-48 bg-white border border-gray-200 rounded-md shadow-lg z-10">
                <div className="py-1">
                  ...
                  {BULK_ACTIONS.map((actionOption) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {actionOption.label}
                        {actionOption.confirmRequired ? <AlertTriangle className="h-3 w-3 text-yellow-500 ml-auto" /> : null}
                      </button>
                    );
                  })}
                </div>
      ...
      {/* 확인 모달 */}
      {confirmAction ? <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
